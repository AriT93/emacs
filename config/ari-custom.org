...
** Nano UI Components
Nano face stubs, color palette, modeline segments, and the doom-modeline/nano-modeline toggle.
Loaded after hc-zenburn and doom-modeline are already active, so no =with-eval-after-load= needed.
