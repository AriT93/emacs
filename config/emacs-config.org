...
#+TAGS: emacs config
#+Time-stamp: <2025-10-05 08:53:52 abturet>
...
** Package Security
Enable package signature verification for enhanced security
#+BEGIN_SRC elisp
...
#+BEGIN_SRC elisp
  ...
  (setq load-source-file-function nil)  ; Disable source file loading for better performance
  ...
  (setq package-archives nil)           ; Disable package archives during startup
...
Suppress warnings about missing lexical-binding cookies in third-party packages
#+BEGIN_SRC elisp
...
#+begin_src elisp
    (use-package quelpa-use-package
      :ensure t
      :defer 10)  ; Defer Quelpa loading
    (use-package copilot
      :quelpa (copilot :fetcher github
                       :repo "copilot-emacs/copilot.el"
                       :branch "main"
                       :files ("*.el"))
      :defer 15)  ; Defer copilot loading
  ...
  (use-package gptel-aibo
    ...
    :defer 20)  ; Defer gptel-aibo loading
