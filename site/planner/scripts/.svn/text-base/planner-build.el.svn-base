...
(add-to-list 'load-path "~/emacs/site/muse/lisp")
(add-to-list 'load-path "~/emacs/site/remember")
(add-to-list 'load-path "~/elisp/bbdb/lisp")
(add-to-list 'load-path "~/emacs/site/bbdb/lisp")
(add-to-list 'load-path "~/emacs/site/erc")
(add-to-list 'load-path "~/elisp/gnats")
(add-to-list 'load-path "~/emacs/site/gnus/lisp")
(add-to-list 'load-path "~/emacs/site/win32/")
(add-to-list 'load-path "~/emacs/site/vm")
(add-to-list 'load-path "~/emacs/site/w3m")
(add-to-list 'load-path "~/elisp/wl")
(add-to-list 'load-path "~/elisp/xtla")
(add-to-list 'load-path "~/emacs/site/planner/contrib/")
