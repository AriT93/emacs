...
(custom-autoload 'nxhtml-menu-mode "../nxhtml/nxhtml-menu" nil)

(autoload 'nxhtml-menu-mode "../nxhtml/nxhtml-menu" "\
...
(autoload 'mason-nxhtml-mumamo-mode "../nxhtml/nxhtml-mumamo" "\
...
(autoload 'gsp-nxhtml-mumamo-mode "../nxhtml/nxhtml-mumamo" "\
...
(custom-autoload 'csharp-mode-hook "../related/csharp-mode" t)
...
(autoload 'flymake-css-load "../related/flymake-css" "\
...
(autoload 'flymake-java-1-load "../related/flymake-java-1" "\
...
(autoload 'flymake-js-load "../related/flymake-js" "\
...
(autoload 'iss-mode "../related/iss-mode" "\
...
(autoload 'iss-mumamo-mode "../related/iss-mumamo" "\
...
(custom-autoload 'global-mozadd-refresh-edited-on-save-mode "../related/mozadd" nil)
...
(custom-autoload 'global-mozadd-mirror-mode "../related/mozadd" nil)
...
(autoload 'visual-basic-mode "../related/visual-basic-mode" "\
...
(autoload 'mumamo-define-html-file-wide-keys "mumamo-fun" "\
...
(autoload 'eruby-javascript-mumamo-mode "mumamo-fun" "\
...
(autoload 'xsl-nxml-mumamo-mode "mumamo-fun" "\
Turn on multi major mode for XSL with main mode `nxml-mode'.
This covers inlined style and javascript." t)

(autoload 'xsl-sgml-mumamo-mode "mumamo-fun" "\
Turn on multi major mode for XSL with main mode `sgml-mode'.
This covers inlined style and javascript." t)

(autoload 'markdown-html-mumamo-mode "mumamo-fun" "\
...
(autoload 'latex-clojure-mumamo-mode "mumamo-fun" "\
...
(autoload 'latex-haskell-mumamo-mode "mumamo-fun" "\
...
(autoload 'python-rst-mumamo-mode "mumamo-fun" "\
...
;;;;;;  "web-autoload.el") (20261 41760 553748))
